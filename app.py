...
if uploaded_file is not None:
    ...
    # showing the dataframe of chats
    # st.dataframe(df)
    # function to display dataframe in streamlit
    ...
    selected_user = st.sidebar.selectbox("Show analysis wrt", unique_users)
    # Stats area
    if st.sidebar.button("Show Analysis"):
        st.title("Top Stats")
        num_messages, num_words, num_media_messages, num_links = helper.fetch_stats(selected_user, df)
        col1, col2, col3, col4 = st.columns(4)  # creates columns
        with col1:
        ...
        # monthly timeline
        # x-axis particular month and y-axis num. of messages
